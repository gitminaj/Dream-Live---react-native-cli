...
import { hostRegisterSchema } from '../../utils/schema/hostRegister';

export default function HostRegister({navigation}) {
  ...
  const handleSubmit = async () => {
    ...
    // Validate form data
    const result = hostRegisterSchema.safeParse(form);
    ...
    try {
      ...
      // Add files
      formData.append('hostLogo', {
        uri: agencyLogo.uri,
        type: agencyLogo.type,
        name: agencyLogo.name,
      });

      formData.append('hostIdProofFile', {
        uri: idProofFile.uri,
    ...
    <View style={styles.container}>
      <ScrollView
        ...
        <View style={styles.elementContainer}>
          <Text style={styles.text}>Host Registration</Text>
          ...
          <View
            style={[
              styles.inputContainer,
              fieldErrors.agencyId && styles.inputError,
            ]}>
            <MaterialIcons
              name="business"
              size={20}
            ...
            <TextInput
              ...
              value={form.agencyId}
              onChangeText={agencyId =>
                handleChange('agencyId', agencyId)
              }
              placeholderTextColor="#8C8C8C"
              style={styles.input}
            />
          ...
          <View style={styles.uploadSection}>
            <Text style={styles.uploadLabel}>Host picture</Text>
            <View style={styles.logoContainer}>
              {agencyLogo ? (
                ...
                <View style={styles.logoPlaceholder}>
                  ...
                  <Text style={styles.placeholderText}>Host picture</Text>
                </View>
              )}
              <TouchableOpacity
                style={styles.uploadButton}
                ...
                <Text style={styles.uploadButtonText}>
                  {agencyLogo ? 'Change picture' : 'Upload picture'}
                </Text>
              </TouchableOpacity>
            </View>
          </View>
